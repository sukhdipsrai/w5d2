...
def craiglockhart_to_sighthill
  ...
  JOIN routes c ON (c.stop_id = b.stop_id)
  JOIN stops stopc ON (stopc.id = c.stop_id)

  JOIN routes d ON (d.company = c.company AND d.num = c.num)
  JOIN stops stopd ON (stopd.id = d.stop_id)
